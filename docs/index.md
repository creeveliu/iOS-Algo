...
参考答案：见 [答案手册 1.8 移除元素](./ios-algorithm-interview-handbook-answers#18-移除元素)
...
参考答案：见 [答案手册 1.9 合并两个有序数组](./ios-algorithm-interview-handbook-answers#19-合并两个有序数组)
...
参考答案：见 [答案手册 1.10 买卖股票的最佳时机](./ios-algorithm-interview-handbook-answers#110-买卖股票的最佳时机)
...
参考答案：见 [答案手册 1.11 排序数组](./ios-algorithm-interview-handbook-answers#111-排序数组)
...
参考答案：见 [答案手册 1.12 合并区间](./ios-algorithm-interview-handbook-answers#112-合并区间)
